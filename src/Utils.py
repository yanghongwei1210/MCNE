...
from src.Bern_model import BernNet
from src.Cheb_model import ChebNetII
...
def get_model(model_opt, nfeat, nclass, A, nhid, out, args, cuda=True):
    ...
    elif model_opt == "MHGCN-ChebNetII":
        model = ChebNetII(nfeat=nfeat,
                         nhid=nhid,
                         out=out,
                         dropout=args.dropout,
                         dprate=args.dprate,
