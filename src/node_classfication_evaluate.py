...
def node_classification_evaluate(model, feature, A,labels,  file_type, device, isTest=True):
    ...
    # feature = torch.tensor(feature.astype(torch.float32).toarray())
    ...
    for _ in range(1):
        ...
        # torch.save(best_netF,  "source_citationv1_F.pt")
        # torch.save(best_netC, "source_citationv1_C.pt")
